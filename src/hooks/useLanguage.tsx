...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'how_to_grow': 'How to grow this money?',
    'investment_options': 'Investment Options',
    'grow_savings': 'How to grow your savings',
    'why_invest': 'Why invest?',
    'why_invest_desc': "Inflation eats your money's value. Investing helps it grow faster than inflation. Always diversify - don't put all eggs in one basket.",
    'risk': 'Risk',
  ...
  hi: {
    ...
    'how_to_grow': 'इस पैसे को कैसे बढ़ाएं?',
    'investment_options': 'निवेश विकल्प',
    'grow_savings': 'अपनी बचत कैसे बढ़ाएं',
    'why_invest': 'निवेश क्यों करें?',
    'why_invest_desc': 'महंगाई आपके पैसे की कीमत कम करती है। निवेश इसे महंगाई से तेज बढ़ने में मदद करता है। हमेशा विविधता लाएं - सभी अंडे एक टोकरी में न रखें।',
    'risk': 'जोखिम',
